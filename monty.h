...
int monty_run(char *content, stack_t **head, unsigned int counter, FILE *file);
...
void monty_mult(stack_t **head, unsigned int counter);
void monty_modul(stack_t **head, unsigned int counter);
...
void monty_addqueue(stack_t **head, int n);
